            ...
            <nav className="flex items-center justify-between flex-wrap bg-gray-800 p-4">
                ...
                <div className="justify-end pr-20">
                    <input type="search" placeholder="Search title here..."/>
                        {/*<svg className = "h-6 w-8 text-white"xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>*/}            </div>
            </nav>
        </div>
